  ...
  return (
    <div>
      ...
      >
        ...
        <CardFooter
          className="p-[12px_8px_12px_16px] border-t border-[#D4E162] h-full flex items-center justify-between"
        >
          <div className="flex gap-2">
            <Button
              variant="outline"
              className="text-sm font-normal !h-[37px] cursor-pointer border-red-500 text-red-500"
              onClick={onDelete}
              disabled={isPending}
            >
              Delete
          ...
          <Button
            variant="ghost"
            disabled={isPrivate}
            className="flex items-center gap-2 cursor-pointer font-light text-sm text-[rgb(0,105,255)] disabled:text-[rgba(26,26,26,0.61)] disabled:bg-[#e7edf6] disabled:opacity-100"
