import {
  ...
  loginType,
  PeriodType,
  PublicAvailabilityEventResponseWithDatesType,
...
export const updateEventMutationFn = async (eventId: string, data: CreateEventPayloadType) => {
...
export const getPublicAvailabilityByEventIdQueryFn = async (
  eventId: string
): Promise<PublicAvailabilityEventResponseWithDatesType> => {
